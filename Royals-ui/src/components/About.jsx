...
const About = () => {
  ...
  return (
    <section
      id="about"
      className="py-24 bg-gradient-to-b from-rose-100 to-pink-100"
    >
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Image Section */}
          <div className="relative group">
            <div className="relative bg-pink-100 rounded-3xl p-6 transform hover:rotate-1 transition-all duration-300 shadow-lg ring-4 ring-rose-300 ring-offset-2 ring-offset-pink-50">
              <div className="bg-rose-100 rounded-3xl p-4 md:p-8 hover:scale-105 transition-all duration-300">
          ...
          <div className="space-y-8">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              At Beauty Nation, we craft experiences that celebrate
              individually. Our master stylists combine technical expertise with
              ...
              {features.map((feature, index) => (
                ...
                >
                  <div className="flex items-start space-x-4">
                    <div className="text-rose-400  p-3 bg-rose-50 rounded-xl group-hover:bg-rose-200">
                      {feature.icon}
                    </div>
                    <div>
...
//                 {/* img section */}
//                 <div className='relative group'>
//                     <div className='absolute inset-0 bg-gradient-to-r from-pink-200 to-rose-200
//                     rounded-3xl transform rotate-2 group-hover:rotate-3 transition-all duration-300'>

//                         <div className='relative bg-pink-100 rounded-3xl p-8 transform'>
//                               <div className='relative bg-rose-100 rounded-3xl p-4 md:p-8
